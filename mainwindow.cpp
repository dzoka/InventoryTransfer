    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->comboBoxFrom->addItem("FiberDraw");
    ui->comboBoxFrom->addItem("Galvena");
    ui->comboBoxTo->addItem("Galvena");
    ui->comboBoxTo->addItem("FiberDraw");
}
...
void MainWindow::on_readyRead()
{
    ...
    if(dataIn.toUtf8().startsWith("OK:"))
    {
        ui->lineEditJournalNumber->setText(dataIn.toUtf8().right(dataIn.toUtf8().length()-3));
    }
...
void MainWindow::on_pushButtonSubmit_clicked()
{
    ...
    QString data;
    data.append("ITJL:");
    data.append(ui->lineEditJournalNumber->text());
    data.append(',');
    data.append((ui->comboBoxFrom->currentText()));
    data.append(',');
    data.append(ui->comboBoxTo->currentText());
    data.append(',');
